...
const ACC_VF_RULES = ["wise", "monzo", "revolut"].map(function (svc) {
  return "RULE-SET,acc-vf-" + svc + "," + BIZ.PAYMENTS;
});
const ACC_FAKE_LOCATION_RULES = [
  "bilibili",
  "kuaishou",
  "xigua",
  "weibo",
...
const GEO_REGIONS_INTL_D_RULES = GEO_REGIONS_INTL.map(function (r) {
  return (
    "RULE-SET,acc-geo-d-" +
...
const GEO_REGIONS_INTL_IP_RULES = GEO_REGIONS_INTL.map(function (r) {
  return (
    "RULE-SET,acc-geo-ip-" +
    r.toLowerCase().replace(/_/g, "-") +
    "," +
